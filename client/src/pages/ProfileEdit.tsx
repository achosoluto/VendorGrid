                ...
                <div className="grid gap-6 md:grid-cols-2">
                  <div className="space-y-2">
                    <Label htmlFor="tax-id">
                      {formData.country === 'CA' ? 'Business Number (BN) *' : 'Tax ID (EIN) *'}
                    </Label>
                    <Input
                      id="tax-id"
                      value={formData.taxId}
                      onChange={(e) => updateField("taxId", e.target.value)}
                      placeholder={formData.country === 'CA' ? '123456789' : 'XX-XXXXXXX'}
                      className="font-mono"
                    ...
                    <p className="text-xs text-muted-foreground">
                      {formData.country === 'CA' 
                        ? '9-digit Canadian Business Number' 
                        : 'US Employer Identification Number'}
                    </p>
                  </div>
                  {formData.country === 'CA' && (
                    <div className="space-y-2">
                      <Label htmlFor="gst-hst">GST/HST Number</Label>
                      <Input
                        id="gst-hst"
                        value={formData.gstHstNumber}
                        onChange={(e) => updateField("gstHstNumber", e.target.value)}
                        placeholder="123456789RT0001"
                        className="font-mono"
                        data-testid="input-gst-hst"
                      />
                      <p className="text-xs text-muted-foreground">
                        15-character GST/HST registration number
                      </p>
                    </div>
                  )}
                </div>
                ...
                {formData.country === 'CA' && (
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                      data-testid="select-legal-structure"
                    >
                      <option value="">Select legal structure</option>
                      <option value="Federal Corporation">Federal Corporation</option>
                      <option value="Provincial Corporation">Provincial Corporation</option>
                ...
                <div className="space-y-2">
                  ...
                  {formData.country === 'CA' ? (
                    ...
                    <Input
                      ...
                      placeholder="State abbreviation (e.g., CA, NY)"
                    />
                  )}
                </div>
                <div className="space-y-2">
