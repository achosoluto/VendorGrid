...
echo "   2. Run the complete system: ./run-demo.sh"
echo "   3. Or start manually:"
echo "      - Backend: npm run dev (http://localhost:5000)"
echo "      - Frontend: cd client && npm run dev (http://localhost:5173)"
echo ""
echo "🎬 Demo options:"
echo "   - Interactive CLI: npm run demo"
echo "   - Web demo: http://localhost/demo.html"
echo "   - Full system: ./run-demo.sh"
echo ""
echo "📚 Features ready:"
echo "   - Canadian business support (BN, GST/HST, provinces)"
echo "   - Government data integration (5 Canadian sources)"
echo "   - Real-time monitoring and analytics"
echo "   - Vendor claiming workflow"
echo "   - Comprehensive demo system"